...
class TestSourceScanner:
    ...
    def temp_project(self, tmp_path):
        ...
        return {"project": project, "src": src, "build": build}

    def test_init(self, temp_project):
        """Test scanner initialization."""
        scanner = SourceScanner(temp_project["project"], temp_project["build"])
...
""")
    ...
    def test_source_collection_all_sources(self, temp_project):
        ...
        collection = SourceCollection(sketch_sources=[Path("sketch.cpp")], core_sources=[Path("wiring.c"), Path("main.cpp")], variant_sources=[Path("pins.cpp")], headers=[Path("config.h")])
