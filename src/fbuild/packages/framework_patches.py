...
ESP32_FRAMEWORK_PATCHES = [
    FrameworkPatch(
        ...
        reason="Fix incorrect relative path in Arduino ESP32 3.3.x (ESP-IDF v5.5 upstream bug)",
        min_version="3.3.5",
        max_version="3.3.6",
    ),
    FrameworkPatch(
        ...
        reason="Fix incorrect function name in Arduino ESP32 3.3.x (should use efuse_hal_get_chip_revision)",
        min_version="3.3.5",
        max_version="3.3.6",
    ),
