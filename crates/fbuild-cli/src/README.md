...
- **`mcp/`** -- MCP (Model Context Protocol) stdio JSON-RPC server; translates AI assistant tool/resource calls into daemon HTTP requests. Exposes `mcp::run_mcp_server` (see `mcp/README.md` for the per-file breakdown).
