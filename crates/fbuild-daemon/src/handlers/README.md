...
- **`emulator/`** -- Emulator deploy handlers (AVR8js, QEMU, simavr), `EmulatorRunner` trait abstraction, `POST /api/test-emu` build-then-emulate flow. See `emulator/README.md` for the submodule layout.
